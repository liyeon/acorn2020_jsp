...
<%
    ...
    //파일을 저장하기 위해 파일을 저장할 폴더의 절대경로를 얻어온다
        ...
        if (formItems != null && formItems.size() > 0) {
            ...
            for (FileItem item : formItems) {
                ...
                if (!item.isFormField()) {//만일 파일 필드라면...
                	...
                	//저장할 파일명 구성(파일명 앞에 time stampe를 출력해서 겹치지 않게 한다. )
                	//1970년 1월1일을 기준으로 1000분의 1초?
                	...
                	//input name="title"에 입력한 문자열읽어오는 부분2
                	if(item.getFieldName().equals("caption")){
                		//필드명이 title이면 제목 읽어오기
                		caption=item.getString("utf-8");
                	//dto.setTitle(title);
                	}
                }//if
            }//for
            //DB 에 파일 정보를 저장한다. 성공여부 저장
