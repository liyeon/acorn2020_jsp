	...
	<div class="container">
		...
		<ul class="navbar-nav">
			<li class="nav-item"><a
				...
				class="nav-link <%if(thisPage.equals("home")){%>active<%}%>">HOME</a></li>
			<li class="nav-item"><a
				href="${pageContext.request.contextPath }/test6/game.jsp"
				class="nav-link <%if(thisPage.equals("game")){%>active<%}%>">GAME</a></li>
			<li class="nav-item"><a
				href="${pageContext.request.contextPath }/test6/study.jsp"
				class="nav-link <%if(thisPage.equals("study")){%>active<%}%>">STUDY</a></li>
		</ul>
	</div>
</div>
